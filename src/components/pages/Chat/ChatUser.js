...
export default function ChatUser() {
  ...
  useEffect(()=>{
    ...
    axios.get(`https://eboardbackend2022.herokuapp.com/user/chat/all/${JSON.parse(localStorage.getItem('login')).User._id}/${JSON.parse(localStorage.getItem('login')).Role}`).then(res=>{
