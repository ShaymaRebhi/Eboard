...
export const AddTask = (
    ...
    const promise = await axios
        .post("https://eboardbackend2022.herokuapp.com/task/add", formData)
        .then((response) => {
...
export const UpdateEvaluation = (
    ...
    const promise = await axios
        .put("https://eboardbackend2022.herokuapp.com/task/updateEvaluationStatus/" + evaluationId, evaluation)
        .then((response) => {
            const data = response.data;
...
export const UpdateTask = (
    ...
    const promise = await axios
        .put("https://eboardbackend2022.herokuapp.com/task/updateQuestionTask/" + taskId, task)
        .then((response) => {
            const data = response.data;
