...
export const RetrieveThemes = createAsyncThunk("/theme", async () => {
  const { data } = await axios.get(
    "https://eboardbackend2022.herokuapp.com/theme"
  );
...
export const AddTheme = createAsyncThunk(
  ...
  async (theme) => {
    const promise = await axios
      .post("https://eboardbackend2022.herokuapp.com/theme", theme)
...
export const GetThemeById = createAsyncThunk(
  ...
  async (themeId) => {
    const promise = await axios
      .get("https://eboardbackend2022.herokuapp.com/theme/" + themeId)
...
export const GetThemeByIdClass = createAsyncThunk(
  ...
  async (idClass) => {
    const promise = await axios
      .get(
        "https://eboardbackend2022.herokuapp.com/theme/findByIdClass/" + idClass
      )
...
export const EditTheme = createAsyncThunk(
  ...
  async (theme) => {
    ...
    const promise = await axios
      .put("https://eboardbackend2022.herokuapp.com/theme/" + theme._id, theme)
...
export const DeleteTheme = createAsyncThunk(
  ...
  async (themeId) => {
    const promise = await axios
      .delete("https://eboardbackend2022.herokuapp.com/theme/" + themeId)
